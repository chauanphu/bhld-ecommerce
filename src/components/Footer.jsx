        ...
        <footer id='contact'>
            <Box>
                <Box sx={{
                    ...
                    }}>Công ty TNHH TM BHLĐ Trần Gia Phát</Typography>
                </Box>
                <Box sx={{
                    py: 3,
            ...
            <Box sx={{
                ...
                <Typography color="white" textAlign="center">Bản quyền thuộc Công ty TNHH TM BHLĐ Trần Gia Phát || thiết kế bởi CAP</Typography>
            </Box>
        </footer>
    )
}
